import time
from activationpw import Sms, SmsTypes, SmsService, GetBalance, GetFreeSlots, GetNumber, SetStatus, GetStatus

"""
create wrapper with secret api-key
search here: http://activation.pw/index.php?act=profile)
"""
wrapper = Sms('API KEY')
